  ...
  ajax: function(url, method, hash) {
    ...
    return new Orbit.Promise(function(resolve, reject) {
      ...
      hash.success = function(json) {
        ...
        if (!localStorage.getItem(projectCode + '-offlineMode')) {
          if (localStorage.getItem(projectCode + '-offlineMode') === 'false') {
                  ...
                  if (project.projectCode === projectCode) {
                    if (!project.infos.offlineMode) {
                      ...
                      for (var i = 0; i < _this.tmpDataStore.length; i++) {
                        localStorage.setItem(_this.tmpDataStore[i].name, _this.tmpDataStore[i].data);
                      }
                      _this.tmpDataStore = [];
                    }
                  }
      ...
      hash.error = function(jqXHR, textStatus, errorThrown) {
        ...
        if (!localStorage.getItem(projectCode + '-offlineMode')) {
          ...
          if (!window.navigator.onLine && localStorage.getItem(projectCode + '-offlineMode') === 'true') {
